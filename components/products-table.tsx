  ...
  const filtered = useMemo(
    () =>
      products
        ...
        .sort((a, b) =>
          sort === 'growth' ? b.growth24h - a.growth24h : sort === 'sales' ? b.sales24h - a.sales24h : b.opportunityScore - a.opportunityScore,
        ),
    [products, q, sort],
  );
